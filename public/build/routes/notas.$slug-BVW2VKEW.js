...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/notas.$slug.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1763747429180.6282";
}
var meta = ({
  data
}) => {
  ...
  const canonical = baseUrl ? `${baseUrl}/notas/${note.slug}` : void 0;
  const ogImage = note.cover.startsWith("http") || !baseUrl ? note.cover : `${baseUrl}${note.cover}`;
  return [{
...
function NotaDetalle() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "bg-gradient-to-b from-slate-50 to-white", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mx-auto max-w-4xl px-6 py-12", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/", className: "text-sm text-slate-500 hover:text-brand", children: "\u2190 Volver a las notas" }, void 0, false, {
      fileName: "app/routes/notas.$slug.tsx",
      lineNumber: 149,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("article", { className: "mt-6 rounded-[32px] border border-slate-100 bg-white/95 px-8 py-10 shadow-lg shadow-slate-100/80", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-xs uppercase tracking-[0.3em] text-slate-400", children: note.category }, void 0, false, {
        fileName: "app/routes/notas.$slug.tsx",
        lineNumber: 153,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "mt-2 font-display text-4xl leading-[1.1] text-brand", children: note.title }, void 0, false, {
        fileName: "app/routes/notas.$slug.tsx",
        lineNumber: 154,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-4 flex flex-wrap gap-3 text-sm text-slate-500", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("time", { dateTime: note.publishedAt, children: new Date(note.publishedAt).toLocaleDateString("es-AR", {
          weekday: "long",
          year: "numeric",
          month: "long",
          day: "numeric"
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: note.cover, alt: note.title, className: "mt-6 w-full rounded-3xl border border-slate-100 object-cover shadow-md", loading: "eager" }, void 0, false, {
        fileName: "app/routes/notas.$slug.tsx",
        lineNumber: 167,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mt-6 text-lg text-slate-600", children: note.summary }, void 0, false, {
        fileName: "app/routes/notas.$slug.tsx",
        lineNumber: 168,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Markdown, { className: "prose prose-lg prose-slate mt-6 max-w-none leading-relaxed", remarkPlugins: [remarkGfm], components: {
        h2: ({
          node: node2,
          ...props
        }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "font-display text-2xl text-brand", ...props }, void 0, false, {
          fileName: "app/routes/notas.$slug.tsx",
          lineNumber: 173,
          columnNumber: 17
        }, this),
        blockquote: ({
          node: node2,
          ...props
        }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("blockquote", { className: "border-l-4 border-brand/70 bg-brand-light/50 px-4 py-2 italic text-slate-600", ...props }, void 0, false, {
          fileName: "app/routes/notas.$slug.tsx",
          lineNumber: 177,
          columnNumber: 17
        }, this),
        ul: ({
          node: node2,
          ...props
        }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { className: "list-disc pl-6 text-slate-700", ...props }, void 0, false, {
          fileName: "app/routes/notas.$slug.tsx",
          lineNumber: 181,
          columnNumber: 17
        }, this),
        ol: ({
          node: node2,
          ...props
        }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ol", { className: "list-decimal pl-6 text-slate-700", ...props }, void 0, false, {
          fileName: "app/routes/notas.$slug.tsx",
          lineNumber: 185,
          columnNumber: 17
        }, this)
      }, children: bodyMarkdown }, void 0, false, {
        fileName: "app/routes/notas.$slug.tsx",
        lineNumber: 169,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-8 flex flex-wrap gap-2", children: note.keywords.map((keyword) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "rounded-full border border-slate-200 px-3 py-1 text-xs uppercase tracking-wide text-slate-500", children: keyword }, keyword, false, {
        fileName: "app/routes/notas.$slug.tsx",
        lineNumber: 190,
        columnNumber: 43
      }, this)) }, void 0, false, {
...
_s(NotaDetalle, "kfiKkwkRy458EpMg8CciiUl94y8=", false, function() {
  return [useLoaderData];
});
_c = NotaDetalle;
var _c;
$RefreshReg$(_c, "NotaDetalle");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  NotaDetalle as default,
  meta
};
//# sourceMappingURL=/build/routes/notas.$slug-BVW2VKEW.js.map
